...
//#define LDAP_AUTH_NONE   ((ber_tag_t) 0x00U  0000 0000    ) /* no authentication */
//#define LDAP_AUTH_SIMPLE ((ber_tag_t) 0x80U  1000 0000    ) /* context specific + primitive */
//#define LDAP_AUTH_SASL   ((ber_tag_t) 0xa3U  1010 0000    ) /* context specific + constructed */
//#define LDAP_AUTH_KRBV4  ((ber_tag_t) 0xffU  1111 1111    ) /* means do both of the following */
//#define LDAP_AUTH_KRBV41 ((ber_tag_t) 0x81U  1000 0001    ) /* context specific + primitive */
//#define LDAP_AUTH_KRBV42 ((ber_tag_t) 0x82U  1000 0010    ) /* context specific + primitive */
...
void 
add_Node(Linklist *List_Head, Str *StrAdd);

Linklist* 
init_Node();

int 
look_Node(Linklist *hard);
